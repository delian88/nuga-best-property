    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <span className="text-2xl font-bold text-fuchsia-700 tracking-tighter">
          ...
          <nav className="hidden md:flex space-x-8">
            <a href="#" className="text-gray-700 hover:text-fuchsia-700 px-3 py-2 text-sm font-medium transition-colors">For Sale</a>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="bg-fuchsia-700 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-fuchsia-800 transition-colors shadow-sm">
              Post a Property
            </button>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 pt-2 pb-6 space-y-1">
          <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700">For Sale</a>
