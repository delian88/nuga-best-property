...
const App: React.FC = () => {
  const [currentView, setCurrentView] = useState<ViewType | 'admin'>('home');
  ...
  const renderHome = () => (
    <>
      ...
      {/* 2. Featured Listings (Intact but enhanced) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            ...
            <div className="hidden md:flex space-x-4">
              <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-emerald-600 hover:border-emerald-600 transition-all cursor-pointer">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 overflow-x-hidden">
      ...
      {showAuth && <Auth onClose={() => setShowAuth(false)} onAuthSuccess={(u) => { setCurrentUser(u); setShowAuth(false); }} />}
